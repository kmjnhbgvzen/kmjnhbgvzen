...
export default function BillingSoftwareForRetail() {
 ...
 Best Digital Marketing Company in Prayagraj
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech delivers result-oriented digital marketing services in Prayagraj, helping businesses build a powerful online presence, connect with the right audience, and turn digital opportunities into long-term success.
          </p>
