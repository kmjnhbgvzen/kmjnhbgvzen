      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
            Reputation Management Agency in Ayodhya
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech Reputation Management services in Ayodhya, Uttar Pradesh with innovative digital marketing solutions that enhance online presence, attract the right audience, and deliver measurable business results.
          </p>
