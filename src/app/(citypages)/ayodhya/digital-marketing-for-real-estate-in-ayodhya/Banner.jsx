    ...
    <main className="bg-white">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          Digital Marketing For Real Estate In Ayodhya
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech digital marketing for real estate in Ayodhya with innovative digital marketing solutions that enhance online presence, attract the right audience, and deliver measurable business results.
          </p>
