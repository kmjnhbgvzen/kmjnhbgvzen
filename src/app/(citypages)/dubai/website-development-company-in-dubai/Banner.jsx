      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6">
            Zentrix Infotech is a trusted Website Development Company in Dubai delivering custom web solutions, responsive design, and modern functionality for businesses across Dubai. Get a FREE consultation today. 
          </p>
