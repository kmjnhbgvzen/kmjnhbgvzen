    ...
    <main className="bg-white">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          Digital Marketing For Coaching Institutes In Meerut
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech empowers businesses in Meerut with innovative digital marketing solutions that enhance online presence, attract the right audience, and deliver measurable business results.
          </p>
