...
export const metadata = {
  title: "USA | Online & IT Services for Businesses",
  description:
    "Online and IT services in the USA for businesses looking to build a strong digital presence and improve efficiency.",
  keywords: [
    "USA online services",
    "IT services USA",
    "business support USA",
  ],
  alternates: {
    canonical: "https://www.zentrixinfotech.com/usa",
  },
  openGraph: {
    title: "USA | Online & IT Services for Businesses",
    description:
      "Online and IT services in the USA for businesses looking to build a strong digital presence and improve efficiency.",
    url: "https://www.zentrixinfotech.com/usa",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "USA | Online & IT Services for Businesses",
      },
    ],
    locale: "en_US",
    type: "website",
    ...
    <div className="bg-white">
      <div className="p-8 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-center mb-4 mt-30">
            ...
            <span className="text-blue-600 font-semibold text-lg">USA</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-medium font-serif text-center mb-4">
            USA – Digital & IT Solutions for Growing Businesses
          </h1>

          <p className="text-gray-700 text-center text-lg mb-0 max-w-7xl mx-auto leading-relaxed">
            The USA is one of the world's most dynamic business markets, home to a thriving ecosystem of startups, SMEs, and multinational enterprises across retail, healthcare, real estate, technology, and professional services. With businesses rapidly shifting to digital-first operations, having the right digital and technology support is essential for staying competitive. We work with businesses across the USA, helping them strengthen their online presence, improve brand visibility, and adopt modern digital solutions that align with today's market needs.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Creating a consistent and compelling brand identity is crucial in a market as competitive as the USA. We help businesses develop cohesive branding strategies that resonate with both local and national audiences. From logo design to complete brand guidelines, we ensure your business stands out and communicates its value effectively in the USA's diverse marketplace.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Analyzing data and refining strategies to achieve better results over time is critical for sustainable business success in the USA. We provide comprehensive analytics and performance monitoring to help you understand what's working and where improvements can be made. Our optimization services ensure your digital investments continue to deliver measurable value and a strong return.
          </p>

          <h3 className="text-xl font-serif font-semibold mb-3">
            Serving All Areas of the USA
          </h3>
          <p className="text-gray-700 leading-relaxed">
            We support businesses located across major cities and commercial hubs throughout the USA. No matter where your business is based, our team is ready to assist you. We understand the unique characteristics and demands of each market and tailor our approach accordingly.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-8">
          <h2 className="text-3xl font-serif font-medium text-center mb-6">
            Why Businesses in the USA Work With Us
          </h2>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    We've worked across diverse sectors in the USA
                  </p>
                </div>
              </div>
            </div>
