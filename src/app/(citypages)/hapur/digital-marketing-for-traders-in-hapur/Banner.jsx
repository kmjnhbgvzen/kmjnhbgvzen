      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
            Digital Marketing For Traders in Hapur
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech delivers result-oriented digital marketing for traders in Hapur, helping businesses build a powerful online presence, connect with the right audience, and turn digital opportunities into long-term success.
          </p>
