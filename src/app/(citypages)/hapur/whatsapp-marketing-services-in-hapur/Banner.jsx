    ...
    <main className="bg-white">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          Whatsapp Marketing Services in Hapur
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech empowers businesses in Ghaziabad with innovative whatsapp marketing services solutions that enhance online presence, attract the right audience, and deliver measurable business results.
          </p>
