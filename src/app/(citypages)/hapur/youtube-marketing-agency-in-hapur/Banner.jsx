    ...
    <main className="bg-white">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
         ...
         Youtube Marketing Agency In Hapur
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech empowers businesses in Ghaziabad with innovative youtube marketing agency solutions that enhance online presence, attract the right audience, and deliver measurable business results.
          </p>
