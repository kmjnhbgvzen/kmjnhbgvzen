  ...
  return (
    <main className="bg-white">
      ...
      >
        ...
        Online Reputation Management IN Hapur
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech empowers businesses in Ghaziabad with innovative online reputation agency solutions that enhance online presence, attract the right audience, and deliver measurable business results.
          </p>
