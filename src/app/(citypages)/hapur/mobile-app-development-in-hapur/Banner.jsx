      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
           Mobile App Development In Hapur
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech delivers result-oriented mobile app development in Hapur, helping businesses build a powerful online presence, connect with the right audience, and turn digital opportunities into long-term success.
          </p>
