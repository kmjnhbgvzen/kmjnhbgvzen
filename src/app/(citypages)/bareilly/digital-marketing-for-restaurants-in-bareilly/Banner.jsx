    ...
    <main className="bg-white">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          Digital Marketing for Restaurants in Bareilly
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech empowers restaurants in Bareilly with innovative Digital Marketing solutions that enhance online presence, attract the right audience, and deliver measurable business results.
          </p>
