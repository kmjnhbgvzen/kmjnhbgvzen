    ...
    <main className="bg-white">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
         ...
         UI/UX Design Services in Bareilly
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech empowers businesses in Bareilly with innovative UI/UX design solutions that enhance user experience, attract the right audience, and deliver measurable business results.
          </p>
