  ...
  return (
    <main className="bg-white">
      ...
      >
        ...
        Video Marketing Services in Bareilly
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech empowers businesses in Bareilly with innovative video marketing solutions that enhance online presence, attract the right audience, and deliver measurable business results.
          </p>
