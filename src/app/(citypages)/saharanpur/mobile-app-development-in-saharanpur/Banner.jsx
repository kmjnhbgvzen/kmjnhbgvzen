      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6">
            Zentrix Infotech delivers result-oriented mobile app development services in Saharanpur, helping businesses build a powerful online presence, connect with the right audience, and turn digital opportunities into long-term success.
          </p>
