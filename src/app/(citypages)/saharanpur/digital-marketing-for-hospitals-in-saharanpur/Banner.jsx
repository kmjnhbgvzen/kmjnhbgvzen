      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
            Digital Marketing for Hospitals in Saharanpur
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech delivers result-oriented digital marketing services for hospitals in Saharanpur, helping healthcare institutions build a powerful online presence, connect with patients and families, and turn digital opportunities into long-term success.
          </p>
