      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
           Online Reputation Management in Ghaziabad
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech empowers businesses in Ghaziabad with innovative online reputation management solutions that enhance their digital presence, build trust with customers, and drive sustainable growth.
          </p>
