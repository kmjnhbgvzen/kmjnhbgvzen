...
export default function BillingSoftwareForRetail() {
 ...
 Online Reputation Management in Varanasi
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech delivers result-oriented Online Reputation Management in Varanasi, helping businesses build a powerful online presence, connect with the right audience, and turn digital opportunities into long-term success.
          </p>
