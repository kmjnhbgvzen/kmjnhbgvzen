...
export default function BillingSoftwareForRetail() {
 ...
 Digital Marketing For Startups in Varanasi
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech delivers result-oriented digital marketing for startups in Varanasi, helping businesses build a powerful online presence, connect with the right audience, and turn digital opportunities into long-term success.
          </p>
