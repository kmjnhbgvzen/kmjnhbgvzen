...
export default function BillingSoftwareForRetail() {
 ...
 Google Ads For Coaching Institute in Varanasi
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech delivers result-oriented google ads for coaching institute in Varanasi, helping businesses build a powerful online presence, connect with the right audience, and turn digital opportunities into long-term success.
          </p>
