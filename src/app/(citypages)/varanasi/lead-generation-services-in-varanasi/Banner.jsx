...
export default function BillingSoftwareForRetail() {
 ...
 Lead Generation Services in Varanasi
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
            Zentrix Infotech delivers result-oriented lead generation services in Varanasi, helping businesses build a powerful online presence, connect with the right audience, and turn digital opportunities into long-term success.
          </p>
