        ...
        <div className="flex-1 px-4 sm:px-8 md:px-16 py-0 order-1 lg:order-1">
          <div className="space-y-8 text-gray-700 leading-relaxed max-w-4xl">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Bundled services clients don't need: Some agencies push comprehensive packages that include services a smaller business may not actually need yet, inflating the total cost unnecessarily.</li>
            ...
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li>Website Development — affordable website development doesn't have to mean a generic template site; many agencies offer custom-designed websites at reasonable prices.</li>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Vague or missing reporting: If an agency can't clearly explain what work was completed and what results it produced, that's a significant red flag.</li>
              <li>Extremely long contracts with no exit option: Affordable shouldn't mean locked in.</li>
              <li>No clear scope of work: A proper proposal should clearly outline exactly what's included each month.</li>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Transparency in Reporting: Agencies that clearly show what's working and what isn't help you make informed decisions.</li>
            ...
            <p>
              Rather than trying to do everything at once, affordable digital marketing often works best when businesses prioritize based on where they'll see the fastest, most meaningful return. For many small businesses, this means starting with local SEO and Google Business Profile optimization, since these efforts often require lower ongoing investment while directly capturing nearby customers actively searching for relevant services. From there, businesses can layer in social media marketing to build brand awareness, followed by PPC campaigns once there's a clear understanding of which keywords and offers convert best.
            </p>
            ...
            <p>
              Before committing to any agency promoting itself as budget-friendly, it's worth asking a few direct questions to confirm the value being offered matches the price point:
            </p>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Can you share examples of similar businesses you've worked with and the results achieved?</li>
            </ul>
            ...
            <div className="space-y-6 mt-6">
              ...
              <div>
                ...
                <p>
                  Only if there's no transparency or clear scope of work. Look for agencies with visible testimonials, like one noting a steady flow of inquiries through social media and search.
                </p>
              </div>
