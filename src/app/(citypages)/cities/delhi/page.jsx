...
export const metadata = {
  title: "Delhi | Online & IT Services for Businesses",
  description:
    "Online and IT services in Delhi for businesses looking to build a strong digital presence and improve efficiency.",
  keywords: [
    "Delhi online services",
    "IT services Delhi",
    "business support Delhi"
  ],
  alternates: {
    canonical: "https://www.zentrixinfotech.com/cities/delhi",
  },

  // ✅ ✅ ✅ OPEN GRAPH (FOR SOCIAL SHARING)
  openGraph: {
    title:
      "Delhi | Online & IT Services for Businesses",

    description:
      "Online and IT services in Delhi for businesses looking to build a strong digital presence and improve efficiency.",

    url: "https://www.zentrixinfotech.com/cities/delhi",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Delhi | Online & IT Services for Businesses",
      },
    ],
      ...
      <div className="p-8 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-center mb-4 mt-30">
            ...
            <span className="text-blue-600 font-semibold text-lg">Delhi</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-medium font-serif text-center mb-4">
            Delhi – Digital & IT Solutions for Growing Businesses
          </h1>

          <p className="text-gray-700 text-center text-lg mb-0 max-w-7xl mx-auto leading-relaxed">
            Delhi is one of India's most active commercial and business centers, hosting a wide range of startups, service providers, and established enterprises. With businesses rapidly moving online, having the right digital and technology support has become essential for sustainable growth. We work with businesses across Delhi, helping them strengthen their online presence, improve brand visibility, and adopt modern digital solutions that align with today's market needs.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        <div className="prose prose-lg max-w-none">
          <h2 className="text-2xl font-serif font-semibold mb-4">
            Supporting Businesses Across Delhi
          </h2>
          <p className="text-gray-700 leading-relaxed mb-6">
            Delhi's diverse business landscape requires flexible and customized solutions. We collaborate with businesses from different sectors, understanding their challenges and offering practical digital support. Our focus is on strategic planning based on local business needs, scalable digital and IT solutions, long-term growth and performance improvement, and clear communication with transparent execution.
          </p>

          <h3 className="text-xl font-serif font-semibold mb-3">
            What We Offer in Delhi
          </h3>
          <p className="text-gray-700 leading-relaxed mb-6">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Creating consistent brand identity that builds trust and recognition is at the heart of what we do. We help businesses in Delhi develop cohesive branding strategies that resonate with their target audience. From logo design to complete brand guidelines, we ensure your business stands out in Delhi's competitive market.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed">
            We support businesses located across South Delhi, North Delhi, East & West Delhi, Central Delhi, and nearby Delhi NCR regions. No matter where you are in Delhi, our team is ready to assist you. We understand the unique characteristics of each area and tailor our approach accordingly.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-8">
          <h2 className="text-3xl font-serif font-medium text-center mb-6">
            Why Businesses in Delhi Work With Us
          </h2>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">We've worked across diverse sectors in Delhi</p>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
