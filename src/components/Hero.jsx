        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            {[
              ...
              <motion.div
                key={i}
                className="bg-gradient-to-br from-white to-gray-50 rounded-lg p-3 border border-gray-100"
          ...
          <div className="relative h-28 bg-gradient-to-t from-orange-50 to-transparent rounded-lg overflow-hidden">
            <div className="absolute inset-0 flex items-end justify-around px-1">
              {[30, 45, 65, 50, 75, 90, 80, 95, 100, 98].map(
                (height, i) => (
                  <motion.div
                    key={i}
                    className="w-[8%] bg-gradient-to-t from-orange-500 to-red-500 rounded-t"
                    initial={{ height: 0 }}
        ...
        >
          ...
          <div className="p-4 font-mono text-sm min-h-[280px]">
            {[
              ...
              >
                <span className="text-gray-600 w-8 text-right mr-4 text-xs">
                  {line.num || ""}
                </span>
    ...
    if (mockupType === "terminal") {
      return (
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <div className="bg-gray-800 border-b border-gray-700 px-4 py-2.5 flex items-center gap-3">
            <div className="flex gap-1.5">
              <div className="w-3 h-3 bg-red-500 rounded-full" />
              <div className="w-3 h-3 bg-yellow-500 rounded-full" />
              <div className="w-3 h-3 bg-green-500 rounded-full" />
        ...
        >
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-5 gap-2">
              {[
                ...
                <motion.div
                  key={i}
                  className={`bg-gradient-to-br ${color} h-12 rounded-lg shadow-md`}
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={{
                    delay: 0.2 + i * 0.1,
          ...
          <div>
            ...
            <div className="flex gap-2">
              <motion.button
                className="px-4 py-2 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-lg text-sm font-semibold shadow-md"
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            {logos.map((logo, i) => (
              <motion.div
                key={i}
                className="bg-gradient-to-br from-blue-100/70 to-cyan-100/40 backdrop-blur-lg border border-white/30 rounded-xl h-24 flex items-center justify-center shadow-lg overflow-hidden"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          className="absolute w-80 h-80 rounded-full blur-3xl opacity-15 bg-gradient-to-r from-pink-500 to-orange-500"
          style={{
            bottom: "20%",
            right: "20%",
          }}
        ...
        >
          ...
          >
            ...
            <div className="w-full">
              ...
              <p className="text-lg sm:text-xl text-gray-600 mt-4 leading-relaxed max-w-xl">
